...
name_file = open("C:\\Users\\Amar Computer\\Desktop\\Riya\\Major\\a.txt", "r")
name_assistant = print(name_file.read())
...
#       screen.iconbitmap('C:\\Users\\Amar Computer\\Desktop\\Riya\\Major\\minijarvis2.ico')
...
#       microphone_photo = PhotoImage(file = "C:\\Users\\Amar Computer\\Desktop\\Riya\\Major\\minijarvis1.jpg")
...
#     try:
#         image = Image.open("C:/Users/Amar Computer/Desktop/Riya/Major/minijarvis1.jpg")
#         microphone_photo = ImageTk.PhotoImage(image)
#         microphone_button = tk.Button(image=microphone_photo, command=Process_audio)
#         microphone_button.pack(pady=10)
